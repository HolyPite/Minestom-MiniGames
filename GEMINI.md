...
- **`ElytraCourseManager`**: Manages a seamless **Elytra Time Trial course** within the Hub instances. Features 50 checkpoints loaded from `checkpoints_elytra.json`, precise **disk-plane passage detection**, automatic start/cancel logic, and per-player visual ring guides.
